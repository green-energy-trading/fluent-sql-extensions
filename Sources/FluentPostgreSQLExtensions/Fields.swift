...
extension Builder {
    ...
    public func createAutoTimestamps(on table: String) throws {
        ...
        self.raw("CREATE TRIGGER \(self.entity.entity)_updated_at_trigger BEFORE UPDATE ON \(self.entity.entity) FOR EACH ROW EXECUTE PROCEDURE set_updated_at();")
        self.raw("""
